###########################################################################
## Makefile generated for component 'EulerRate'. 
## 
## Makefile     : EulerRate_rtw.mk
## Generated on : Sun Apr 04 11:11:10 2021
## Final product: ./EulerRate.a
...
PRODUCT_NAME              = EulerRate
MAKEFILE                  = EulerRate_rtw.mk
MATLAB_ROOT               = /Applications/MATLAB_R2021a.app
MATLAB_BIN                = /Applications/MATLAB_R2021a.app/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/maci64
START_DIR                 = /Users/dariusmensah/Desktop/CapstoneFunctions/codegen/lib/EulerRate
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=EulerRate
...
SRCS = $(START_DIR)/EulerRate_data.cpp $(START_DIR)/EulerRate_initialize.cpp $(START_DIR)/EulerRate_terminate.cpp $(START_DIR)/EulerRate.cpp
...
OBJS = EulerRate_data.o EulerRate_initialize.o EulerRate_terminate.o EulerRate.o
...
EulerRate_data.o : $(START_DIR)/EulerRate_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


EulerRate_initialize.o : $(START_DIR)/EulerRate_initialize.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


EulerRate_terminate.o : $(START_DIR)/EulerRate_terminate.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


EulerRate.o : $(START_DIR)/EulerRate.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
